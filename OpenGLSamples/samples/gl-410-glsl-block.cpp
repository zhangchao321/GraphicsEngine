...
namespace
{
	char const* VERT_SHADER_SOURCE("gl-410/glsl-block.vert");
	char const* FRAG_SHADER_SOURCE1("gl-410/glsl-block1.frag");
	char const* FRAG_SHADER_SOURCE2("gl-410/glsl-block2.frag");
...
private:
	bool initProgram()
	{
		...
		if(Validated)
		{
			...
			GLuint FragShaderName1 = Compiler.create(GL_FRAGMENT_SHADER, getDataDirectory() + FRAG_SHADER_SOURCE1, "--version 410 --profile core");
			GLuint FragShaderName2 = Compiler.create(GL_FRAGMENT_SHADER, getDataDirectory() + FRAG_SHADER_SOURCE2, "--version 410 --profile core");

			ProgramName = glCreateProgram();
			glAttachShader(ProgramName, VertShaderName);
			glAttachShader(ProgramName, FragShaderName1);
			glAttachShader(ProgramName, FragShaderName2);
