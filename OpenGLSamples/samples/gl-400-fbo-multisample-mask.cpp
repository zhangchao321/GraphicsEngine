...
namespace
{
	char const* VERT_SHADER_SOURCE("gl-400/fbo-multisample-mask.vert");
	char const* FRAG_SHADER_SOURCE("gl-400/fbo-multisample-mask.frag");
...
public:
	sample(int argc, char* argv[])
		: framework(argc, argv, "gl-400-fbo-multisample-mask", framework::CORE, 4, 0, glm::vec2(glm::pi<float>() * 0.2f))
		, VertexArrayName(0)
		, BufferName(0)
		, ProgramName(0)
		, UniformMVP(0)
